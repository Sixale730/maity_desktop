...
// Re-export Tauri commands. Tauri 2.11 (`tauri-macros 2.6+`) genera DOS símbolos por
// comando: el const wrapper `__cmd__*` (runtime) y el macro_rules
// `__tauri_command_name_*` (compile-time match en generate_handler!). Ambos deben estar
// en el módulo referenciado por el invoke_handler.
pub use commands::{
