...
// Re-export con AMBOS símbolos requeridos por Tauri 2.11 (__cmd__* + __tauri_command_name_*).
pub use commands::{
    ...
    __tauri_command_name_builtin_ai_cancel_download,
    __tauri_command_name_builtin_ai_delete_model,
    ...
    __tauri_command_name_builtin_ai_is_model_ready,
    ...
    builtin_ai_get_recommended_model, builtin_ai_is_model_ready,
    builtin_ai_list_models, init_model_manager, ModelManagerState,
};
pub use model_manager::{ModelInfo, ModelStatus};
pub use models::{
    get_available_models, get_default_model, get_model_by_name, get_models_for_tier, ModelDef,
    ModelTier,
};
