...
import { BatchRecordingHero } from './BatchRecordingHero';
...
export function TranscriptPanel({
  ...
  // la sesión — el usuario creería que el micrófono no funciona. Desde sep-2026
  // el hueco lo llena `BatchRecordingHero` (temporizador + barras por canal +
  // Ritmo/tiempo de palabra + último tip): el texto de "transcribiendo al
  // finalizar" solo dejaba la pantalla vacía toda la sesión.
      ...
      <div className="pb-20">
        <div className="flex justify-center">
          <div className="w-2/3 max-w-[750px]">
            {isBatchLive ? (
              <div className="px-4 py-2" data-testid="batch-live-empty-state">
                <BatchRecordingHero />
              </div>
            ) : (
