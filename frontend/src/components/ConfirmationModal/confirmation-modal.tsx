  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-card rounded-lg p-6 max-w-md w-full mx-4">
        <h2 className="text-xl font-semibold text-foreground mb-4">Confirmar Eliminación</h2>
        <p className="text-muted-foreground mb-6">{text}</p>
        <div className="flex justify-end space-x-4">
          <button
            onClick={onCancel}
            className="px-4 py-2 text-muted-foreground hover:bg-card-hi rounded-md transition-colors"
          >
            Cancelar
          </button>
          <button
