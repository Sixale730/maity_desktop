  ...
  return (
    ...
    <div className="flex items-center gap-2 text-[10px] relative">
      ...
      <div className="relative">
        ...
        {openDropdown === 'mic' && (
          <div className="absolute bottom-full left-0 mb-1 z-[60] bg-white dark:bg-gray-900 border border-border rounded-md shadow-lg py-1 min-w-[200px] max-h-[200px] overflow-y-auto">
