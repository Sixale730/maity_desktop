...
export function HeadphonesRecommendationWarning({
  ...
  return (
    <div className="mb-3 mx-auto w-2/3 max-w-[750px] min-w-[200px] flex justify-center">
      <div className="bg-card text-card-foreground border border-yellow-500/30 rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.3)] px-5 py-3 flex items-center gap-3 w-full">
        ...
        <button
          ...
          className="flex-shrink-0 p-1 text-muted-foreground hover:text-foreground rounded-lg transition-colors"
