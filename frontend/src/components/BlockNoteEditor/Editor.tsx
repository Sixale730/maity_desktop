...
export default function Editor({ initialContent, onChange, editable = true }: EditorProps) {
  ...
  // eslint-disable-next-line @typescript-eslint/no-require-imports -- dynamic require needed to avoid SSR issues with BlockNote
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any -- BlockNote internal API
