  ...
  return (
    ...
    >
      <div className="flex flex-col items-center space-y-8">
        ...
        {/* Features Card */}
        <div className="w-full max-w-md mx-auto bg-card rounded-lg border border-border shadow-sm p-6 space-y-4">
        ...
        <div className="w-full max-w-xs mx-auto">
          <Button
            onClick={handleStart}
            className="w-full h-11 bg-maity-green hover:bg-maity-green/90 text-gray-900 font-medium"
          >
