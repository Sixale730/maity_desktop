...
export function OfflineIndicator({
  ...
  if (showBackendWarning && !isBackendReachable) {
    return (
      <div className={`bg-yellow-100 text-yellow-800 dark:bg-yellow-900/40 dark:text-yellow-200 px-4 py-2 flex items-center justify-center gap-2 text-sm ${className}`}>
