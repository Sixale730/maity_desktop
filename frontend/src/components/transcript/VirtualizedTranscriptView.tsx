...
// Speaker indicator component for visual differentiation
const SpeakerIndicator = memo(function SpeakerIndicator({
    ...
    if (sourceType === 'user') {
        return (
            <span className="text-xs flex-shrink-0" title="Tú (micrófono)">
                🎤
            </span>
        );
    }
    ...
    return (
        <span className="text-xs flex-shrink-0" title="Otro (speaker)">
            🔊
        </span>
    );
});
        ...
        <div id={`segment-${id}`} className="mb-3">
            <div className="flex items-start gap-2">
                ...
                <div className="flex-1">
                    {isStreaming ? (
                        <div className={`${bgClass} border rounded-lg px-3 py-2`}>
                ...
                >
                    {isRecording ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-12">
                            ...
                            <h2 className="text-3xl font-bold text-foreground mb-2">¡Bienvenido a Maity!</h2>
                            <p className="text-base text-muted-foreground mb-6">Tu coach de comunicación</p>
                            <div className="flex items-center gap-6 mb-6">
                                <div className="flex items-center gap-1.5 text-sm text-muted-foreground">
                                    <span>🎤</span><span>Graba</span>
                                </div>
                                <div className="flex items-center gap-1.5 text-sm text-muted-foreground">
                                    <span>📊</span><span>Analiza</span>
                                </div>
                                <div className="flex items-center gap-1.5 text-sm text-muted-foreground">
                                    <span>🚀</span><span>Mejora</span>
                                </div>
                            </div>
                            <p className="text-sm text-muted-foreground/70 max-w-[280px] text-center leading-relaxed">
