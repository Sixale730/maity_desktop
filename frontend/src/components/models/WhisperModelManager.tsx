      ...
      <div className="p-4">
        <div className="flex items-start justify-between mb-3">
          <div className="flex-1">
            ...
            {/* Tagline */}
            <p className="text-sm text-muted-foreground ml-9">{getModelTagline(model.name, model.speed, model.accuracy)}</p>

            {/* Model Specs */}
            <div className="flex items-center space-x-4 text-sm text-muted-foreground ml-9 mt-2">
